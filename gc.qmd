...
## MGP Trace and Density Plots for Regression Coefficients (β1) {.smaller}
...
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

i = 1
plot(1:n_iter, beta_mat[i, ], type = "l",
     main = paste("Trace: beta", i), xlab = "Iteration", ylab = "Value")
plot(density(beta_mat[i, ], adjust = 1),
     main = paste("Density: beta", i), xlab = "Value", ylab = "Density")

# Reset the plotting layout to the default (single plot per figure)
par(mfrow = c(1, 1))
```

## MGP Trace and Density Plots for Regression Coefficients (β2) {.smaller}
...
## MGP Trace and Density Plots for Regression Coefficients (β3) {.smaller}
...
## MGP Trace and Density Plots for Regression Coefficients (β4) {.smaller}
...
## MGP Trace and Density Plots for Hyperparameters (τ²) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

plot(1:n_iter, tausq_mcmc[1, ], type = "l",
     main = "Trace: tausq", xlab = "Iteration", ylab = "Value")
plot(density(tausq_mcmc[1, ], adjust = 1),
     main = "Density: tausq", xlab = "Value", ylab = "Density")

# Reset the plotting layout to the default (single plot per figure)
par(mfrow = c(1, 1))
```

## MGP Trace and Density Plots for Hyperparameters (φ) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

plot(1:n_iter, phi_chain, type = "l",
     main = "Trace: phi (spatial decay)", xlab = "Iteration", ylab = "Value")
plot(density(phi_chain, adjust = 1),
     main = "Density: phi (spatial decay)", xlab = "Value", ylab = "Density")

# Reset the plotting layout to the default (single plot per figure)
par(mfrow = c(1, 1))
```

## MGP Trace and Density Plots for Hyperparameters (σ²) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

plot(1:n_iter, sigmasq_chain, type = "l",
     main = "Trace: sigma^2 (GP variance)", xlab = "Iteration", ylab = "Value")
plot(density(sigmasq_chain, adjust = 1),
     main = "Density: sigma^2 (GP variance)", xlab = "Value", ylab = "Density")
...
## NNGP Trace and Density Plots for Regression Coefficients (β1) {.smaller}
...
## NNGP Trace and Density Plots for Regression Coefficients (β2) {.smaller}
...
## NNGP Trace and Density Plots for Regression Coefficients (β3) {.smaller}
...
## NNGP Trace and Density Plots for Regression Coefficients (β4) {.smaller}
...
## NNGP Trace and Density Plots for Regression Coefficients (β5) {.smaller}
...
## NNGP Trace and Density Plots for Regression Coefficients (β) - Analysis {.smaller}
...
## NNGP Trace and Density Plots for Hyperparameters (φ) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

param = colnames(theta_mcmc)[1]
...
## NNGP Trace and Density Plots for Hyperparameters (σ²) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

param = colnames(theta_mcmc)[2]
...
## NNGP Trace and Density Plots for Hyperparameters (τ²) {.smaller}

```{r}
# Set up the plotting layout to show two plots side by side
par(mfrow = c(1, 2))

param = colnames(theta_mcmc)[3]
...
## NNGP Trace and Density Plots for Hyperparameters - Analysis {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects (w(1131)) {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects (w(397)) {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects (w(318)) {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects (w(266)) {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects (w(1354)) {.smaller}
...
## Trace and Density Plots for Selected Latent Spatial Effects - Analysis {.smaller}
